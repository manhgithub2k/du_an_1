        ...
        <div class="col-10">
            <form action="?act=addvoucher" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" name="ma_voucher" value="<?= isset($ma_Voucher) ? $ma_voucher : '' ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="ngay_batdau" name="ngay_batdau" onchange="checkTimeBatDau()" value="<?= isset($ngay_batdau) ? $ngay_batdau : '' ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="ngay_ketthuc" name="ngay_ketthuc" onchange="checkTimeKetThuc()" value="<?= isset($ngay_ketthuc) ? $ngay_ketthuc : '' ?>">
