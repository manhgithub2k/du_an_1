        ...
        <div class="col-10">
            <form action="?act=editvoucher&id=<?=$id_voucher?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="exampleInputPassword1" name="ngay_batdau" value="<?= $ngay_batdau ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="exampleInputPassword1" name="ngay_ketthuc" value="<?= $ngay_ketthuc ?>">
